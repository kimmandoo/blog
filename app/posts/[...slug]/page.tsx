...
// Helper function to map image size config to Tailwind classes
const getImageMaxWidthClass = (size: string) => {
  const sizeMap: Record<string, string> = {
    'sm': 'prose-img:max-w-sm',
    'md': 'prose-img:max-w-md',
    'lg': 'prose-img:max-w-lg',
    'xl': 'prose-img:max-w-xl',
    '2xl': 'prose-img:max-w-2xl',
    'full': '',
  };
  return sizeMap[size] || '';
};
          ...
          <div className="py-8">
            ...
            <div 
              className={`prose ${themeConfig.prose.size} dark:prose-invert max-w-none
                ...
                prose-img:rounded-lg prose-img:mx-auto prose-img:block ${getImageMaxWidthClass(themeConfig.postImage.maxWidth)}`}
