      ...
      <div className="sticky top-0 z-50 bg-gray-950/95 backdrop-blur-sm border-b border-gray-800">
        <div className="h-16 px-6 flex items-center justify-between max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/blockchain" className="text-sm font-medium text-purple-400 hover:text-purple-300 transition-colors flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link 
              href="/" 
              className="px-3 py-1.5 text-sm font-medium text-gray-300 bg-gray-800 hover:bg-gray-700 rounded-md transition-colors border border-gray-700"
            >
              Blog
            </Link>
          </div>
        ...
        <main className="flex-1 min-w-0 lg:flex lg:gap-8">
          ...
          <article className="flex-1 min-w-0 px-8 py-12 max-w-4xl mx-auto lg:mx-0">
            ...
            <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
              <Link href="/blockchain" className="hover:text-purple-400 transition-colors">
                Blockchain
              </Link>
              <svg className="w-4 h-4" fill="none" strokeWidth="2" stroke="currentColor" viewBox="0 0 24 24">
                <path d="M9 5l7 7-7 7" />
            ...
            <header className="mb-12">
              ...
              {item.tags && item.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-4">
                  {item.tags.map((tag) => (
                    <span key={tag} className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-900/30 text-purple-300 border border-purple-500/20">
                      #{tag}
                    </span>
                  ))}
                </div>
            ...
            <div className="pb-12 border-b border-gray-800">
              ...
              <div 
                className={`prose ${themeConfig.prose.size} prose-invert max-w-none
                  prose-headings:font-semibold prose-headings:text-white prose-headings:scroll-mt-20
                  prose-h1:${themeConfig.prose.h1} prose-h1:mb-6 prose-h1:mt-12
                  prose-h2:${themeConfig.prose.h2} prose-h2:mb-4 prose-h2:mt-10 prose-h2:pb-2 prose-h2:border-b prose-h2:border-gray-800
                  prose-h3:${themeConfig.prose.h3} prose-h3:mb-3 prose-h3:mt-8
                  prose-p:text-gray-300 prose-p:leading-relaxed prose-p:mb-6
                  prose-a:text-purple-400 hover:prose-a:text-purple-300 prose-a:font-medium prose-a:no-underline hover:prose-a:underline prose-a:transition-colors
                  prose-strong:text-white prose-strong:font-bold
                  prose-code:text-purple-400 prose-code:bg-gray-800 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:before:content-none prose-code:after:content-none prose-code:font-mono prose-code:text-sm
                  prose-pre:bg-gray-900 prose-pre:border prose-pre:border-gray-800 prose-pre:rounded-lg prose-pre:p-4
                  prose-blockquote:border-l-4 prose-blockquote:border-purple-500 prose-blockquote:bg-purple-900/10 prose-blockquote:text-gray-300 prose-blockquote:pl-4 prose-blockquote:py-2 prose-blockquote:italic
                  ...
                  prose-img:rounded-lg prose-img:border prose-img:border-gray-800 prose-img:mx-auto prose-img:block`}
