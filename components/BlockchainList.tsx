...
export function BlockchainList({ items }: BlockchainListProps) {
  ...
  const groupedItems = useMemo(() => {
    const groups: Record<string, BlockchainData[]> = {};
  ...
  return (
    <>
      {/* Search Bar */}
      <div className="mb-8">
        <SearchBar onSearch={setSearchQuery} placeholder="제목, 내용, 카테고리, 태그로 검색..." />
      </div>
