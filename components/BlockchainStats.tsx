...
export function BlockchainStats({ items }: BlockchainStatsProps) {
  ...
  // Blockchain-themed color palette (purples, cyans, teals)
  const colors = [
    ...
    { solid: '#D946EF', gradient: ['#D946EF', '#C026D3'] }, // fuchsia
    { solid: '#2DD4BF', gradient: ['#2DD4BF', '#14B8A6'] }, // light teal
    { solid: '#818CF8', gradient: ['#818CF8', '#6366F1'] }, // light indigo
    { solid: '#F472B6', gradient: ['#F472B6', '#EC4899'] }, // light pink
    { solid: '#34D399', gradient: ['#34D399', '#10B981'] }, // emerald
  ];
  ...
  return (
    <div className="mt-6 p-6 rounded-xl bg-gradient-to-br from-gray-900 via-gray-900 to-purple-900/20 border border-purple-500/20 shadow-lg shadow-purple-500/5">
      <div className="flex items-center justify-between gap-8 flex-wrap">
        ...
        <div className="flex-1 min-w-[280px]">
          ...
          <div className="flex items-center justify-center relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-56 h-56 rounded-full bg-gradient-to-br from-purple-900/30 via-cyan-900/20 to-violet-900/30 blur-2xl opacity-50"></div>
            </div>

            {/* Pie Chart SVG */}
            <svg viewBox="0 0 220 220" className="w-64 h-64 relative" style={{ filter: 'drop-shadow(0 4px 6px rgba(0, 0, 0, 0.3))' }}>
              <defs>
              ...
              <circle cx="110" cy="110" r="48" fill="#030712" />
              <circle cx="110" cy="110" r="48" fill="none" stroke="rgba(168,85,247,0.1)" strokeWidth="2" />
            </svg>
        ...
        {/* Reading Time */}
        <div className="flex flex-col items-center justify-center p-6 rounded-xl bg-gray-900 border border-gray-700/50 shadow-sm min-w-[160px] hover:shadow-md hover:shadow-purple-500/10 transition-shadow">
          <div className="p-3 rounded-full bg-purple-900/30 mb-3">
            <svg className="w-7 h-7 text-purple-400" fill="none" strokeWidth="2" stroke="currentColor" viewBox="0 0 24 24">
